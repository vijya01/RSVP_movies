...
-- Number of rows in movies coulumn = 7997

SELECT COUNT(*) FROM Genre;
-- Number of rows in genre coulumn = 14662

SELECT COUNT(*) FROM Director_mapping;
-- Number of rows in Director_mapping coulumn = 3867

SELECT COUNT(*) FROM Role_mapping;
-- Number of rows in Role_mapping coulumn = 15615

SELECT COUNT(*) FROM Names;
-- Number of rows in Names coulumn = 25735

SELECT COUNT(*) FROM Ratings;
-- Number of rows in ratings coulumn = 7997
...
-- In the year 2017 and in March month highest number of movies released.
...
-- Drama genre has highest number of movies produced overall.
...
-- Action genre has the highest duration.
...
-- Thriller has 3rd rank and the movie count is 1484.
...
-- Average rating is greater than 9 in top 3 movies.
...
-- Dream Warrior Pictures and National Theatre Live have rank 1 and their movie count is 3.
...
-- 24 Drama movies released in each genre during March 2017 in the USA had more than 1,000 votes.
...
SELECT
  ...
  German_votes,   
     (SELECT SUM(total_votes) AS Italian_votes
      ...
      ORDER  BY r.total_votes DESC)
Italian_votes;
-- Yes German movies get more votes than Italian movies and the count of German votes are 4421525 and Italian votes are 2559540.
